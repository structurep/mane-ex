      ...
      <div className="divide-y divide-crease-light">
        ...
        <CheckItem
          ...
          detail={l.ppe_on_file && l.ppe_document_url ? (
            <a href={l.ppe_document_url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-saddle hover:underline">
        ...
        <CheckItem
          ...
          detail={l.show_record_linked && l.show_record_url ? (
            <a href={l.show_record_url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-saddle hover:underline">
