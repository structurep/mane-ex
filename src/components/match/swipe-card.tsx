      ...
      >
        ...
        <div className="relative h-full w-full">
          ...
          {active && (
            <div
              ref={likeBadgeRef}
              className="pointer-events-none absolute left-4 top-4 z-20 rounded-lg border-[3px] border-saddle bg-saddle/20 px-5 py-2 backdrop-blur-sm"
              style={{ opacity: 0, transform: `rotate(-${BADGE_ROTATION_DEG}deg) scale(${BADGE_SCALE_MIN})` }}
            >
              <span className="text-lg font-black tracking-wider text-saddle">LIKE</span>
            </div>
          )}
          ...
          {active && (
            <div
              ref={passBadgeRef}
              className="pointer-events-none absolute right-4 top-4 z-20 rounded-lg border-[3px] border-saddle bg-saddle/20 px-5 py-2 backdrop-blur-sm"
              style={{ opacity: 0, transform: `rotate(${BADGE_ROTATION_DEG}deg) scale(${BADGE_SCALE_MIN})` }}
            >
              <span className="text-lg font-black tracking-wider text-saddle">PASS</span>
            </div>
          )}
