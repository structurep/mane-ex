      ...
      <div className="mx-auto grid max-w-5xl gap-5 md:grid-cols-2">
        ...
        <div className="paper-flat flex items-start gap-5 p-6">
          ...
          <div>
            ...
            <Link
              href="/iso/new"
              className="mt-3 inline-flex items-center gap-1 text-sm font-medium text-coral hover:text-coral-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded-sm"
            >
              Create an ISO
