      ...
      <div className="flex flex-col gap-3 rounded-lg border border-crease-light bg-paper-cream p-4 shadow-flat sm:flex-row sm:items-end">
        <div className="flex-1">
          ...
          <input
            ...
            autoFocus
            className="mt-1.5 w-full rounded-lg border border-crease-light bg-paper-white px-3 py-2 text-sm text-ink-black placeholder:text-ink-faint focus:border-oxblood focus:outline-none focus:ring-1 focus:ring-oxblood/20"
          />
        </div>
