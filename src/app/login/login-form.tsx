        ...
        <form action={passwordAction} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              autoComplete="email"
              className="h-10 w-full rounded-lg border border-crease-light bg-paper-white px-3 text-sm text-ink-dark placeholder:text-ink-faint focus:border-oxblood focus:outline-none focus:ring-1 focus:ring-oxblood/20"
