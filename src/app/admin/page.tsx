...
const actionConfig: Record<string, { label: string; icon: ReactNode; bg: string }> = {
  ...
  manual_notification: { label: "Sent notification", icon: <Bell className="h-4 w-4 text-saddle" />, bg: "bg-saddle/5" },
};
...
export default async function AdminOverviewPage() {
  ...
  const kpis = [
    ...
    { label: "Active Listings", value: stats.activeListings, icon: ListChecks, accent: "text-saddle" },
