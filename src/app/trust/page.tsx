      ...
      <main>
        ...
        <section className="with-grain bg-gradient-hero px-4 pt-24 pb-16 md:px-8 md:pt-36 md:pb-20">
          <div className="mx-auto max-w-[1200px] text-center">
            <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-[var(--radius-card)] bg-saddle/10">
              <Shield className="h-8 w-8 text-saddle" />
            </div>
            <p className="overline mb-3 text-saddle">TRUST & SAFETY</p>
        ...
        <section className="bg-paper-white section-premium">
          <div className="mx-auto max-w-[800px]">
            <div className="mb-8 text-center">
              <p className="overline mb-3 text-saddle">MANEVAULT ESCROW</p>
            ...
            <div className="space-y-4">
              {[
                ...
                >
                  <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-saddle text-sm font-bold text-white">
                    {item.step}
                  </span>
                  <div>
