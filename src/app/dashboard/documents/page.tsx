...
export default function DocumentsVaultPage() {
  ...
  return (
    <>
      ...
      {/* Storage meter */}
      <div className="mb-6 rounded-lg border border-border bg-paper-cream p-4">
        ...
        <div>
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              className="w-full rounded-lg border border-border bg-paper-white py-2 pl-10 pr-4 text-sm text-ink-black placeholder:text-ink-light focus:border-blue focus:outline-none focus:ring-1 focus:ring-blue"
            />
          </div>
              ...
              <div key={horseName} className="mb-6">
                ...
                <div className="space-y-2">
                  {docs.map((doc) => (
                    <div
                      key={doc.id}
                      className="flex items-center gap-3 rounded-lg border border-border bg-paper-white p-3"
                    >
                      {/* Icon */}
