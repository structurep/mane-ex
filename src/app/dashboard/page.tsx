...
export default async function DashboardPage() {
  ...
  const pipelineStages = [
    ...
    { stage: "Active", count: statusCounts["active"] || 0, textColor: "text-saddle" },
    { stage: "Offer", count: pendingOfferCount || 0, textColor: "text-saddle" },
    { stage: "Sold", count: statusCounts["sold"] || 0, textColor: "text-saddle" },
  ];
  ...
  // KPI stats
  const kpis = [
    { label: "Active Listings", value: (listingCount || 0).toLocaleString(), icon: ClipboardList, href: "/dashboard/listings", accent: "text-saddle" },
    ...
    { label: "Saves", value: totalFavorites.toLocaleString(), icon: Heart, accent: "text-saddle/70" },
    { label: "Pending Offers", value: (pendingOfferCount || 0).toLocaleString(), icon: DollarSign, href: "/dashboard/offers", accent: "text-saddle" },
    ...
    <div>
          ...
          <AlertBanner variant="warning" title="Needs your attention" className="mb-6">
            <p className="text-sm">
              {actions.map((a, i) => (
                <span key={i}>
                  {i > 0 && " · "}
                  <Link href={a.href} className="font-medium text-saddle hover:underline">{a.text}</Link>
                </span>
              ))}
            </p>
          </AlertBanner>
      ...
      {isBuyerUnverified && (
        <AlertBanner variant="info" title="Improve your buyer profile" className="mb-6">
          <p className="text-sm">
            ...
            <Link href="/dashboard/settings" className="font-medium text-saddle hover:underline">
              Complete profile
            </Link>
          </p>
        </AlertBanner>
      ...
      <div className="mb-8 grid gap-6 lg:grid-cols-2">
        ...
        <section>
          <SectionHeading
            ...
            actions={
              <Link href="/dashboard/messages" className="text-sm font-medium text-saddle hover:underline">
                View all
              </Link>
            }
          />
      ...
      {hasListings ? (
        <section className="mb-8">
          <SectionHeading
            title="Your Listings"
            actions={
              <Link href="/dashboard/listings" className="text-sm font-medium text-saddle hover:underline">
              ...
              <div className="space-y-2">
                {suggestions.slice(0, 3).map((s, i) => (
                  ...
                  >
                    ...
                    <span className="ml-2 whitespace-nowrap font-semibold text-saddle">{s.points}</span>
                  </Link>
                ))}
              </div>
            </div>
      ...
      <section className="mb-8">
        ...
        <ActionPanel
          className="mt-2"
          items={[
            { label: "New Listing", icon: <Plus className="h-4 w-4" />, href: getCreateListingUrl(), accent: "text-saddle" },
            ...
            { label: "View Analytics", icon: <BarChart3 className="h-4 w-4" />, href: "/dashboard/analytics", accent: "text-saddle" },
