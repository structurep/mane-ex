      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <select
            ...
            name="category"
            required
            className="mt-1.5 h-10 w-full cursor-pointer appearance-none rounded-lg border border-crease-light bg-paper-cream px-3 text-sm text-ink-dark transition-colors focus:border-saddle focus:outline-none focus:ring-1 focus:ring-saddle/20"
          >
