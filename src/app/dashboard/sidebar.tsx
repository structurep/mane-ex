...
export function DashboardSidebar() {
  ...
  return (
    <aside className="sticky top-14 hidden h-[calc(100vh-3.5rem)] w-56 shrink-0 border-r border-border bg-washi md:block">
      <div className="flex h-full flex-col p-4">
        {/* New listing CTA */}
        <Button size="sm" className="mb-6 w-full" asChild>
