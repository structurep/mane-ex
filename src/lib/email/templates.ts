...
<head>
  ...
  <style>
    body { font-family: 'Inter', -apple-system, sans-serif; background: #F8F6F1; color: #1C1410; margin: 0; padding: 0; }
    .container { max-width: 560px; margin: 0 auto; padding: 40px 20px; }
    .card { background: #FFFFFF; border: 1px solid #DDD8CE; border-radius: 8px; padding: 32px; }
    .logo { font-family: 'Space Grotesk', sans-serif; font-size: 20px; font-weight: 700; color: #1C1410; text-decoration: none; }
    .btn { display: inline-block; background: #8B5E3C; color: #FFFFFF; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-weight: 600; font-size: 14px; }
    .btn-outline { display: inline-block; border: 1px solid #1C1410; color: #1C1410; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: 500; font-size: 14px; }
    .footer { margin-top: 32px; text-align: center; font-size: 12px; color: #9A8E82; }
    .footer a { color: #9A8E82; }
    h1 { font-family: 'Space Grotesk', sans-serif; font-size: 24px; margin: 0 0 16px; }
    p { font-size: 15px; line-height: 1.6; color: #5A4E42; margin: 0 0 16px; }
...
export function newMessageEmail(
  ...
  return {
    ...
    html: layout(`
      ...
      <p style="font-size: 13px; color: #9A8E82;">Do not share personal financial information in messages.</p>
    `),
  };
}
...
export function offerReceivedEmail(
  ...
  return {
    ...
    html: layout(`
      ...
      <div class="highlight">
        <p style="margin:0; font-size: 24px; font-weight: 700; color: #1C1410;">${offerAmount}</p>
      ...
      <p style="font-size: 13px; color: #9A8E82;">You can accept, counter, or decline from your dashboard.</p>
    `),
  };
}
...
export function reviewRequestEmail(
  ...
  return {
    ...
    html: layout(`
      ...
      <p style="font-size: 13px; color: #9A8E82;">Reviews are public and contribute to seller scoring.</p>
    `),
  };
}
  ...
  return {
    ...
    html: layout(`
      ...
      <div class="highlight">
        ...
        <p style="margin:4px 0 0;"><span style="text-decoration: line-through; color: #9A8E82;">${oldPrice}</span> &rarr; <strong style="color: #8B5E3C;">${newPrice}</strong></p>
      </div>
      <p style="text-align: center; margin-top: 24px;">
...
export function transportRequestEmail(
  ...
  return {
    ...
    html: layout(`
      ...
      <p style="font-size: 13px; color: #9A8E82;">Transport estimates are approximate. Final arrangements are between buyer, seller, and carrier.</p>
    `),
  };
}
...
export function transportProviderLeadEmail(
  ...
  return {
    ...
    html: layout(`
      ...
      <p style="font-size: 13px; color: #9A8E82;">This lead was matched based on your service regions. Contact the seller through the listing page to discuss arrangements.</p>
    `),
  };
}
